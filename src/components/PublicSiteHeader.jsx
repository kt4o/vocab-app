...
export function PublicSiteHeader({ showPromo = true }) {
  return (
    <header className="sticky top-0 z-50 border-b border-border/40 bg-white">
      {showPromo ? (
        <div className="border-b border-[#d9e6ff] bg-[#eef4ff] px-4 py-2">
          <div className="mx-auto flex w-full max-w-[1280px] items-center justify-between gap-3 text-[13px] text-foreground">
            <p>
